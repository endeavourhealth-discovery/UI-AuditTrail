export class DisplayDetails {
  ...
  getChangedLinkedItemsDisplayDetails(): any[] {
    return [
      ...
      { label: 'Added data processing agreement', property: 'AddedDATAPROCESSINGAGREEMENT'},
      { label: 'Removed data processing agreement', property: 'RemovedDATAPROCESSINGAGREEMENT'},
      ...
      { label: 'Updated purpose', property: 'UpdatedPURPOSE'},
      { label: 'Removed purpose', property: 'RemovedPURPOSE'},
      { label: 'Added benefit', property: 'AddedBENEFIT'},
      { label: 'Updated benefit', property: 'UpdatedBENEFIT'},
      ...
      { label: 'Updated extract technical details', property: 'UpdatedEXTRACTTECHNICALDETAILS'},
      ...
      { label: 'Updated schedule', property: 'UpdatedSCHEDULE'},
      { label: 'Removed schedule', property: 'RemovedSCHEDULE'},
      { label: 'Added address', property: 'AddedADDRESS'},
      { label: 'Updated address', property: 'UpdatedADDRESS'},
      { label: 'Removed address', property: 'RemovedADDRESS'},
      { label: 'Added publishing data processing agreement', property: 'AddedPUBLISHINGDATAPROCESSINGAGREEMENT'},
      { label: 'Removed publishing data processing agreement', property: 'RemovedPUBLISHINGDATAPROCESSINGAGREEMENT'},
      { label: 'Added parent organisation', property: 'AddedPARENTORGANISATION'},
      { label: 'Removed parent organisation', property: 'RemovedPARENTORGANISATION'},
      { label: 'Added child organisation', property: 'AddedCHILDORGANISATION'},
      { label: 'Removed child organisation', property: 'RemovedCHILDORGANISATION'},
      { label: 'Added subscribing data sharing agreement', property: 'AddedSUBSCRIBINGDATASHARINGAGREEMENT'},
      { label: 'Removed subscribing data sharing agreement', property: 'RemovedSUBSCRIBINGDATASHARINGAGREEMENT'},
      { label: 'Added publishing data sharing agreement', property: 'AddedPUBLISHINGDATASHARINGAGREEMENT'},
      { label: 'Removed publishing data sharing agreement', property: 'RemovedPUBLISHINGDATASHARINGAGREEMENT'},
    ]
  }
